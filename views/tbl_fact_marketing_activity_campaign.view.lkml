...
# }
  ...
  measure: target_vadx_vs_actual {
    ...
    type: number
    sql: sum(${fact_budget.variable_ad_expense_as_percent_of_sales_target} - ${fact_marketing_activty_campaign.new_existing_variable_ad_expense_as_percent_of_sales}) ;;
  }
